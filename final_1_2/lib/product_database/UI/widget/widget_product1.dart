...
class ProductWidget1 extends StatefulWidget {
  const ProductWidget1({super.key});

  @override
  State<ProductWidget1> createState() => _ProductWidget1State();
}

class _ProductWidget1State extends State<ProductWidget1> {
...
//var x = ba;
  ...
  Widget build(BuildContext context) {
    ...
    setState(() {
      _ctrlProductBarcode.text = myDataProvider.myData.count;
      _product.Barcode = myDataProvider.myData.count;
    });
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              Container(
                                margin: const EdgeInsets.only(
                                    top: 15, left: 4, right: 4, bottom: 5),
                                child: TextFormField(
                                  ...
                                  onSaved: (val) =>
                                      setState(() => _product.Barcode = val),
                                ),
                              ),

                              Container(
                                margin: const EdgeInsets.only(
                                    top: 10, left: 4, right: 4, bottom: 5),
                                child: TextFormField(
                                  style: const TextStyle(color: Colors.white),
                                  ...
                                  child: VisibilityDetector(
                                    ...
                                    child: BarcodeKeyboardListener(
                                      ...
                                      onBarcodeScanned: (barcode) {
                                        ...
                                        print(barcode);
                                        setState(() {
                                          _ctrlProductBarcode.text = barcode;
                              ...
                              Container(
                                margin: const EdgeInsets.only(
                                    top: 10, left: 4, right: 4, bottom: 15),
                                width: width * 0.174,
                                height: 50,
                                child: ElevatedButton(
                                  style: ButtonStyle(
